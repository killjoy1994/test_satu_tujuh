                ...
                <div className='mt-9'>
                    <div className='md:mt-5 bg-slate-800 px-5 py-6 rounded-md shadow-xl'>
                        <div >
                            ...
                            <div className='mt-1 relative flex bg-slate-800 items-center justify-between h-16 rounded-sm xl:max-w-[500px]'>
                                <input onKeyDown={(e) => onEnterPress(e)} onChange={(e) => setInputtedAgent(e.target.value)} value={inputtedAgent} className='w-full px-3 py-1 mr-2 block rounded-md bg-slate-700 text-slate-50 text-lg 
                                font-medium' type="text" placeholder='Search agent name...' />
                                <div className='px-2 absolute top-5 right-2'>
                                    <MagnifyingGlassIcon height={25} width={25} className='text-slate-400' />
                                </div>
                            </div>
                        </div>
                        <div className='mt-3'>
